        ...
        <div class="container mx-auto px-6 py-3 flex justify-between items-center">
            ...
            <div class="hidden md:flex space-x-6">
                ...
                <a href="administradorProductos.php" class="flex items-center text-white hover:bg-blue-700 py-2 px-4 rounded transition duration-500">
                    <img src="../images/productosicon.png" alt="Productos" class="h-6 w-6 mr-2" />
                    Productos
                </a>
            ...
            <div class="flex items-center">
                <a href="../../backend/login_register_reset/login_user.php" class="ml-4 px-4 py-2 bg-green-600 text-white rounded-lg hover:bg-green-700">
                    <i class='bx bxs-user-plus'></i>
                </a>
                <a href="../../backend/login_register_reset/logout.php" class="ml-4 px-4 py-2 bg-yellow-600 text-white rounded-lg hover:bg-yellow-700">
