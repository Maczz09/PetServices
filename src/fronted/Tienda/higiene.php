...
/// Obtener ID de la categoría "Higiene"
$sql_categoria = $con->prepare("SELECT id_categoria FROM categorias WHERE nombre_categoria = 'Higiene'");
                ...
                <div class="col-lg-4 col-md-6 mb-4">
                    <div class="card h-100 border border-gray-300 shadow-sm">
                        ...
                        <div class="card-footer d-flex justify-content-between">
                            ...
                            <a href="agregar_carrito.php" class="btn btn-success btn-sm agregar-carrito-btn" data-id="<?php echo $row['id_producto']; ?>">Agregar</a>
                        </div>
                    </div>
                </div>
            <?php endforeach; ?>
